...
La méthode `main` dans [src/main/java/com/bytelegend/Cat.java lèvera](https://github.com/ByteLegendQuest/java-fix-method-return-npe/blob/main/src/main/java/com/bytelegend/Cat.java) une `NullPointerException` ( `NPE` ), veuillez la corriger.
...
-   Вы можете выполнить эту задачу любым способом, указанным ниже:
    ...
    -   Или: если вы знакомы с GitHub, вы можете разветвить [репозиторий](https://github.com/ByteLegendQuest/java-fix-method-return-npe) , выполнить задание и создать запрос на включение.
